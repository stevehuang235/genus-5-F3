...
```2-tuples-f3.txt``` - representatives of $$\operatorname{PGL}_5(\mathbf{F}_3)$$-orbits of two-dimensional subspaces of the space of quadrics in $$\mathbf{P}^4$$, equivalently, $$\operatorname{PGL}_5(\mathbf{F}_3)$$-orbits of $$\operatorname{Gr}(2,15)$$.
